            ...
            case CartLoadedSuccessState:
              ...
              final String formattedPrice =
                  NumberFormat.currency(locale: 'vi_VN', symbol: '₫')
                      .format(successState.mycart.total ?? 0);
              if (successState.listproduct == null ||
                  successState.listproduct!.isEmpty) {
                return Scaffold(
                  appBar: AppBar(
                            ...
                            children: [
                              ...
                              Expanded(
                                child: GestureDetector(
                                  onTap: () {
                                    cartBloc
                                        .add(RemoveAllProductClickedEvent());
          ...
          children: [
            ...
            GestureDetector(
              onTap: () {
                ...
                Navigator.of(context).pop();
                cartBloc.add(ConfirmOrderClickedEvent(
                    listproductcart: CartItem.selectedProducts));
              },
              child: Container(
